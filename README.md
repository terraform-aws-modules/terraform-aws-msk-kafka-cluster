...
| <a name="input_connect_custom_plugins"></a> [connect\_custom\_plugins](#input\_connect\_custom\_plugins) | Map of custom plugin configuration details (map of maps) | <pre>map(object({<br/>    name              = string<br/>    description       = optional(string)<br/>    content_type      = string<br/>    s3_bucket_arn     = string<br/>    s3_file_key       = string<br/>    s3_object_version = optional(string)<br/>    timeouts = object({<br/>      create = optional(string)<br/>      delete = optional(string)<br/>    })<br/>  }))</pre> | `{}` | no |
