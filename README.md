...
| <a name="input_topics"></a> [topics](#input\_topics) | Map of MSK topics to create | <pre>map(object({<br/>    partition_count    = number<br/>    replication_factor = number<br/>    configs            = optional(string)<br/>  }))</pre> | `{}` | no |
