...
| <a name="input_client_unauthenticated_access_enabled"></a> [client\_unauthenticated\_access\_enabled](#input\_client\_unauthenticated\_access\_enabled) | Controls whether unauthenticated access is enabled or not | `bool` | `false` | no |
